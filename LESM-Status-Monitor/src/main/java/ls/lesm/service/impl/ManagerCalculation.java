...
public class ManagerCalculation {
	...
	public Double manager_cal(int ManagerEmployeeId)
	{

		List<MasterEmployeeDetails> ls = masterEmployeeDetailsRepository.findBymasterEmployeeDetails_Id(ManagerEmployeeId);
...
//			}
			...
			profit_or_loss = (Double) lc.lead_cal(Employeeid .getEmpId());
        ...
        Double Total_profit_or_loss = sub_profit - bc.Employee_cal(ManagerEmployeeId);
